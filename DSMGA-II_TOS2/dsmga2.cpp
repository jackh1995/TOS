...
using namespace std;
#define GA string("FFF")
#define RM_QUEUE_SIZE 20
...
void DSMGA2::update_orderILS(size_t lastUB) {
    ...
    // for (int i=0; i!=rm_success_sizes_count.size(); ++i) {
    //     cout << rm_success_sizes_count[i] << '/';
    // } cout<<endl;
